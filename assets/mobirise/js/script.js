! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.className = "engine";
        a.innerHTML = '<a href="https://mobiri.se">Mobirise</a> Mobirise v4.7.7';
...
(function(a) {
    a.extend(a.easing, {
        easeInOutCubic: function(a, b, e, k, f) {
            return 1 > (b /= f / 2) ? k / 2 * b * b * b + e : k / 2 * ((b -= 2) * b * b + 2) + e
        }
    });
        ...
        var m = function() {
            ...
            if (b.length) {
                ...
                a.each(b, function(a, c) {
                    ...
                    c.content && e.showInfo && google.maps.event.addListenerOnce(b,
                        "animation_changed",
                        function() {
                            setTimeout(function() {
                                g.open(h, b)
